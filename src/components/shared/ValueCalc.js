      ...
      <div className="row">
        <div className="col-12 col-md-12 col-lg-8">
          ...
          <p className="text-left Goldankauf_para2_">
            Unsere zahlreichen Kunden können sich nicht irren! Wir bieten Ihnen
            den Ankauf von Zahngold, Silber- und Goldbarren, Goldmünzen und
            Goldschmuck zu sehr attraktiven Ankaufskonditionen an.
          </p>
