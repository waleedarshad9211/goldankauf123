          ...
          <div className="col-12 col-md-12 col-lg-8">
            ...
            <div className="sicherheit_wrapper_paras">
              <p className="sicherheit_wrapper_para1">
                ...
                Verkauf völlig ohne Risiko möglich macht. Wenn man es genau
                nimmt, ist der Verkauf bei uns sogar sicherer als bei einem
                Juwelier, einem Leihhaus oder einem Bankinstitut, da Sie bei uns
              </p>
            ...
            <p className="mb-2">
              ...
              kostenlos von einem diskreten Werttransport-Unternehmen bei Ihnen
              zu Hause oder im Büro abholen.
            </p>
            {sicherheitArray?.map((item, index) => {
              return (
                <div key={index} className="sicherheit_wrapper_main">
                  <h3 className="sicherheit_wrapper_heading">{item.heading}</h3>
